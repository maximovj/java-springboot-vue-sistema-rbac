<template>
  <CustomCardFiltros
      ...
      @update:modelValue="visibleModel = $event"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
          ...
          <span class="p-input-icon-left w-full">
            <span>
              ...
              <span class="font-bold text-sm ml-2">Acción</span>
            </span>
            <InputText
          ...
          <span class="p-input-icon-left w-full">
            <span>
              <i class="pi pi-box" />
              <span class="font-bold text-sm ml-2">Módulo</span>
            </span>
            <InputText
              v-model="model.modulo"
          ...
          <span class="w-full">
            <span>
              ...
              <span class="font-bold text-sm ml-2">Fecha creación (Rango)</span>
            </span>
